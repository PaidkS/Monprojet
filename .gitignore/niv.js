    ...
    if (message.content === "!aide"){
      ...
      if (message.content === "!menu"){
        var menuembed = new Discord.RichEmbed()
          ...
          .setColor("#dc143c")
          .setTimestamp()          
          .addField("Niveau : 1","", inline=True )
          .addField("Guilde : Aucune","", inline=True )
          .addField("Titre : Aucun","", inline=True )
          .addField(">Stats 📈","", inline=False )
          .addField(">Aide 🔍","", inline=False )
          .addField(">Option ⚙️","", inline=False )        
          .setFooter("Naenelis Bot");
