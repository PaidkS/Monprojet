...
bot.on("message", message => {
    ...
    if (message.content === "!aide"){
        var helpembed = new Discord.RichEmbed()
          ...
          .setDescription("├ **!contexte :** vous donne le xontexte du rp  ")
          .setDescription("├ **!fiche :** vous donne la template fiche rp ")
          .setDescription("├ **!serverinfo :** pour voir les infos du serveur ")
