...
bot.on("message", message => {
    ...
    if (message.content === "!aide"){
      ...
      if (message.content.includes('!aide Royaume')) {
      ...
      if (message.content.includes('!aide Histoire')) {
