    ...
    if (message.content === "!aide"){
      ...
      if (message.content === "!menu"){
        var menuembed = new Discord.RichEmbed()
          ...
          .addField("──────────────", "**📖     :3770_this_animated_right: Ouvrir son grimmoire** ")      
          .addField("──────────────", "**🔍     :3770_this_animated_right: Ouvrir le menu d'aide** ")    
          .addField("──────────────", "**⚙️     :3770_this_animated_right: Ouvrir le menu Option** ")  
          .setFooter("Naenelis Bot")
